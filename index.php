        ...
        <div class="joe_index">
                  ...
                  <div class="swiper-wrapper">
                    <?php foreach ($carousel as $item) : ?>
                      <div class="swiper-slide">
                        <a class="item" href="<?php echo $item['url'] ?>" rel="noopener noreferrer nofollow">
          ...
          <?php if ($index_ad) : ?>
            <div class="joe_index__ad">
              <a class="joe_index__ad-link" href="<?php echo $index_ad['url'] ?>" rel="noopener noreferrer nofollow">
          ...
          <div class="joe_index__title">
            ...
            <?php if ($index_notice) : ?>
              <div class="joe_index__title-notice">
                ...
                <a href="<?php echo $index_notice['url'] ?>" rel="noopener noreferrer nofollow"><?php echo $index_notice['text'] ?></a>
              </div>
            <?php endif; ?>
          </div>
